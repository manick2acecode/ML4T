...
def plot_image(in_sample, out_sample, title, xlabel, ylabel, ylim_2, legend, image_name):
    plt.plot(in_sample)
    plt.plot(out_sample)
    plt.title(title)
    plt.xlabel(xlabel)
...
def question_1(train_x_prm, train_y_prm, test_x_prm, test_y_prm):
    rmse_in_sample = []
    rmse_out_sample = []
    for i in range(1, 21):
        # create a learner and train it
        learner_tmp = dtlearn.DTLearner(leaf_size=i, verbose=True)
    ...
    # plot the image
    plot_image(rmse_in_sample, rmse_out_sample, "DTLearner - RMSE vs Leaf Size", "Leaf Size", "RMSE", 0.01, ["In-Sample", "Out-Sample"], "Question-1.png")


def question_2(train_x_prm, train_y_prm, test_x_prm, test_y_prm):
    rmse_in_sample = []
    rmse_out_sample = []
    for i in range(1, 21):
        # create a learner and train it
        ...
        rmse_out_sample.append(rmse_out)
    # plot the image
    plot_image(rmse_in_sample, rmse_out_sample, "BagLearner - RMSE vs Leaf Size (10 Bags)", "Leaf Size", "RMSE", 0.01, ["In-Sample", "Out-Sample"], "Question-2.png")


def question_3_i(train_x_prm, train_y_prm):
    time_dtlearner = []
    time_rtlearner = []
    ...
    # plot the image
    plot_image(time_dtlearner, time_rtlearner, "Training Time - DTLearner vs RTLearner", "Leaf Size", "Time (milliseconds)", 0.25, ["DTLearner", "RTLearner"], "Question-3-i.png")


def question_3_ii(train_x_prm, train_y_prm):
    mae_dtlearner = []
    mae_rtlearner = []
    # DT Learner Time to run calculation
    for i in range(1, 21):
    ...
    # plot the image
    plot_image(mae_dtlearner, mae_rtlearner, "MAE - DTLearner vs RTLearner", "Leaf Size", "MAE", 0.8, ["DTLearner", "RTLearner"], "Question-3-ii.png")
...
if __name__ == "__main__":
    ...
    # Question 1, DTLearner - RMSE vs Leaf Size
    question_1(train_x, train_y, test_x, test_y)

    # Question 2, BagLearner(10 Bags) - RMSE vs Leaf Size
    question_2(train_x, train_y, test_x, test_y)

    # Question 3.i, Training Time - DTLearner vs RTLearner
    question_3_i(train_x, train_y)

    # Question 3.ii, MAE - DTLearner vs RTLearner
    question_3_ii(train_x, train_y)
